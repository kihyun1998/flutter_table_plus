  ...
  group('a group is answered on the members it actually has (#151)', () {
    testWidgets('isLastRow: rowKeys out of data order', (tester) async {
      ...
      expect(
        ...
        isNull,
        reason:
            'the group is the last row whichever order its keys are '
    ...
    testWidgets('isLastRow: the control, same group in data order', (
      ...
      expect(
        ...
        isNull,
        reason:
            'the ordered fixture already passed before #151 — it is here '
    ...
    testWidgets('isLastRow: a group that really is not last still draws', (
      ...
      expect(
        ...
        reason:
            'and it is the ROW boundary at full alpha, not a member '
    ...
    testWidgets('isLastRow: rowKeys naming a row data does not hold', (
      ...
      expect(
        ...
        isNull,
        reason:
            'the tail is the latest member that is present, and a key '
    ...
    testWidgets('hoverData: the first key names a row data does not hold', (
      ...
      expect(
        ...
        findsOneWidget,
        reason:
            'the button used to vanish entirely: hoverData read '
    ...
    testWidgets('hoverData: the control, every key present', (tester) async {
      ...
      expect(
        ...
        findsOneWidget,
        reason:
            'unchanged when nothing is absent — the fix adds a fallback, '
