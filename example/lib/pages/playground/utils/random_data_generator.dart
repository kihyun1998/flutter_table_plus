...
class RandomDataGenerator {
  ...
  static const List<String> _firstNames = [
    ...
    'Aaron', 'Virginia', 'Jose', 'Julie', 'Adam', 'Joyce', 'Nathan', 'Victoria',
    'Henry', 'Olivia', 'Douglas', 'Kelly', 'Zachary', 'Christina', 'Peter', 'Lauren',
  ...
  static List<Map<String, dynamic>> generateEmployees(int count, {int startId = 1}) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      final baseSalary = position.contains('Senior') || position.contains('Manager') || position.contains('Director')
  ...
  static int generateSalary(String position) {
    if (position.contains('Senior') || position.contains('Manager') || position.contains('Director')) {
