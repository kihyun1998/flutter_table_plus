...
*   **INTERNAL**: `lib/` changed in exactly three places this release — the two fixes above and nothing else. (This line read "one place" until the second fix landed under the same open version, which is the shape it now warns about.)
